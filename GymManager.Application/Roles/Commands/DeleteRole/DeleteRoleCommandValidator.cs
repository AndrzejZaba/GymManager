...
public class DeleteRoleCommandValidator : AbstractValidator<DeleteRoleCommand>
{
        ...
        IUserRoleManagerService userRoleManagerService)
    {
        ...
        RuleFor(x => x.Id)
            ...
            .WithMessage(@$"Nie można usunąć wybranej roli, ponieważ są do niej przypisani użytkownicy. 
                Jeżeli chcesz usunąć wybraną rolę, to najpierw wypisz z niej wszystkich użytkowników.");
    }
