...
public class Email : IEmail
{
    ...
    public async Task SendAsync(string subject, string body, 
        string to, string attachementPath = null)
    {
        ...
        if(!string.IsNullOrEmpty(attachementPath))
            builder.Attachments.Add(attachementPath);
        ...
        using(var client = new SmtpClient())
        {
            ...
            await client.AuthenticateAsync(!string.IsNullOrWhiteSpace(_senderLogin) ?
                _senderLogin : _senderEmail, _senderEmailPassword);
